...
public static class ApiEndPointConstant
{
    ...
    public static class User
    {
        ...
        public const string StaffEndPoint = ApiEndpoint + "/resigter/staff";
        public const string AccountEndPoint = ApiEndpoint + "/resigter/customer";
    ...
    public static class WarrantyDetail
    {
        ...
        public const string WarrantyDetailsEndPointDetail = WarrantyDetailsEndPoint + "/{id}/Detail";
